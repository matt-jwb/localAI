    ...
    def __init__(self, model_location, sys_prompt):
        ...
        if self.is_gptq:
            ...
            try:
                ...
                self.model = AutoGPTQForCausalLM.from_quantized(self.model_path, use_safetensors=True, device="cuda:0", use_triton=False, inject_fused_attention=False, use_exllama=True)
            except:
